...
while(element && element  !== lastCard) {
...
//  Nice—your J2 code is exactly right:
//  • snap is a static NodeList → its .length stays the same.
//  • The fresh document.querySelectorAll('.card').length reflects the new card.
//  • Cleaning up with article.remove() is perfect.
...
const button = document.querySelector('[data-action="add"]');           //  or '.btn.add'
